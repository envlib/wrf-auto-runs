...
# =============================================================================
# Phase 3 unified per-chunk job. One container does:
...
# (run_wrf_hetzner.sl) submits N chained copies. Each one auto-detects which
...
IMAGE_VERSION="1.8"
SHARED_BASE="/shared/wrf_data"
SIF_PATH="${SHARED_BASE}/${IMAGE_NAME}_${IMAGE_VERSION}.sif"
WPS_GEOG_PATH="${SHARED_BASE}/WPS_GEOG"
