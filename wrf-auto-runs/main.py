...
from upload_namelists import (
    upload_run_inputs, download_run_inputs, cleanup_run_inputs,
)
...
def derive_wrf_run_context():
    ...
    return domains, outputs, end_date, rename_dict
...
if params.wrf_only:
    ...
    domains, outputs, end_date, rename_dict = derive_wrf_run_context()
